...
import styles from "@/components/home/products/products.module.css";
import Image from "next/image";
import img1 from "@/public/images/home/products/confetture.webp";
import img2 from "@/public/images/home/products/biscmac.png";
import img3 from "@/public/images/home/products/cioccolato.webp";
import img4 from "@/public/images/home/products/torte.webp";
  ...
  return (
    <>
      ...
      <div className={styles.presentazioneContainer}>
        ...
        <div className={styles.right}>
          <div className={styles.imageWrapper}>
            <Image alt={img1} src={img1} className={styles.image} />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className={styles.right}>
          <div className={styles.imageWrapper}>
            <Image alt={img2} src={img2} className={styles.image} />
          </div>
        </div>
      </div>
      ...
      {showAll && (
        <>
          <div className={styles.presentazioneContainer}>
            ...
            <div className={styles.right}>
              <div className={styles.imageWrapper}>
                <Image alt={img3} src={img3} className={styles.image} />
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className={styles.right}>
              <div className={styles.imageWrapper}>
                <Image alt={img4} src={img4} className={styles.image} />
              </div>
            </div>
          </div>
        </>
